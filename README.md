...
**Current count: 3370** (as of 2026-03-07)
...
Last 7d averaged **9.9/day** vs **9.4/day** prior 7d (+4.5%) — **not statistically significant** (z = 0.19)

Current 7d rate sits at the **76th percentile** of all daily rates (z = 1.79 vs all-time mean of 7.3/day)

### Daily Rate Distribution

| Period | Mean/day | Median/day | Std Dev | Min | Max | N days |
|--------|----------|------------|---------|-----|-----|--------|
| 7d | 9.9 | 11.0 | 3.6 | 5.0 | 14.0 | 7 |
| 14d | 9.6 | 10.5 | 4.2 | 2.0 | 16.0 | 14 |
| 30d | 9.0 | 7.0 | 4.1 | 2.0 | 17.0 | 30 |
| all-time | 7.3 | 7.0 | 3.7 | 1.0 | 21.0 | 137 |

### Acceleration Tests

| Window | Recent avg | Prior avg | Change | Std Dev (R) | Std Dev (P) | z-score | Significant? |
|--------|-----------|-----------|--------|-------------|-------------|---------|--------------|
| 7d vs prior 7d | 9.9 | 9.4 | +4.5% | 3.6 | 4.7 | 0.19 | not significant |
| 14d vs prior 14d | 9.6 | 8.6 | +11.6% | 4.2 | 4.2 | 0.63 | not significant |
...
| 2026-W10 | 2026-03-02 to 2026-03-07 | +55 | 9.2 |
