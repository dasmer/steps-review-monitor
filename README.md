...
**Current count: 3192** (as of 2026-02-16)
...
Last 7d averaged **9.7/day** vs **7.7/day** prior 7d (+25.9%) — **not statistically significant** (z = 1.14)

Current 7d rate sits at the **80th percentile** of all daily rates (z = 2.03 vs all-time mean of 7.0/day)

### Daily Rate Distribution

| Period | Mean/day | Median/day | Std Dev | Min | Max | N days |
|--------|----------|------------|---------|-----|-----|--------|
| 7d | 9.7 | 10.0 | 3.9 | 6.0 | 17.0 | 7 |
| 14d | 8.7 | 8.0 | 3.4 | 3.0 | 17.0 | 14 |
| 30d | 8.3 | 8.5 | 3.3 | 3.0 | 17.0 | 30 |
| all-time | 7.0 | 7.0 | 3.5 | 1.0 | 21.0 | 118 |

### Acceleration Tests

| Window | Recent avg | Prior avg | Change | Std Dev (R) | Std Dev (P) | z-score | Significant? |
|--------|-----------|-----------|--------|-------------|-------------|---------|--------------|
| 7d vs prior 7d | 9.7 | 7.7 | +25.9% | 3.9 | 2.5 | 1.14 | not significant |
| 14d vs prior 14d | 8.7 | 7.8 | +11.9% | 3.4 | 3.3 | 0.73 | not significant |
