...
**Current count: 3377** (as of 2026-03-07)
...
Last 7d averaged **10.9/day** vs **9.4/day** prior 7d (+15.2%) — **not statistically significant** (z = 0.67)

Current 7d rate sits at the **81th percentile** of all daily rates (z = 2.45 vs all-time mean of 7.4/day)

### Daily Rate Distribution

| Period | Mean/day | Median/day | Std Dev | Min | Max | N days |
|--------|----------|------------|---------|-----|-----|--------|
| 7d | 10.9 | 12.0 | 3.0 | 5.0 | 14.0 | 7 |
| 14d | 10.1 | 11.0 | 4.1 | 2.0 | 16.0 | 14 |
| 30d | 9.2 | 7.5 | 4.1 | 2.0 | 17.0 | 30 |
| all-time | 7.4 | 7.0 | 3.7 | 1.0 | 21.0 | 137 |

### Acceleration Tests

| Window | Recent avg | Prior avg | Change | Std Dev (R) | Std Dev (P) | z-score | Significant? |
|--------|-----------|-----------|--------|-------------|-------------|---------|--------------|
| 7d vs prior 7d | 10.9 | 9.4 | +15.2% | 3.0 | 4.7 | 0.67 | not significant |
| 14d vs prior 14d | 10.1 | 8.6 | +17.4% | 4.1 | 4.2 | 0.96 | not significant |
...
| 2026-W10 | 2026-03-02 to 2026-03-07 | +62 | 10.3 |
