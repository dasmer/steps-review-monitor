...
**Current count: 3320** (as of 2026-03-02)
...
Last 7d averaged **9.6/day** vs **8.3/day** prior 7d (+15.5%) — **not statistically significant** (z = 0.56)

Current 7d rate sits at the **77th percentile** of all daily rates (z = 1.66 vs all-time mean of 7.2/day)

### Daily Rate Distribution

| Period | Mean/day | Median/day | Std Dev | Min | Max | N days |
|--------|----------|------------|---------|-----|-----|--------|
| 7d | 9.6 | 10.0 | 5.2 | 2.0 | 16.0 | 7 |
| 14d | 8.9 | 6.8 | 4.4 | 2.0 | 16.0 | 14 |
| 30d | 8.6 | 7.0 | 4.1 | 2.0 | 17.0 | 30 |
| all-time | 7.2 | 7.0 | 3.7 | 1.0 | 21.0 | 132 |

### Acceleration Tests

| Window | Recent avg | Prior avg | Change | Std Dev (R) | Std Dev (P) | z-score | Significant? |
|--------|-----------|-----------|--------|-------------|-------------|---------|--------------|
| 7d vs prior 7d | 9.6 | 8.3 | +15.5% | 5.2 | 3.2 | 0.56 | not significant |
| 14d vs prior 14d | 8.9 | 8.9 | 0.0% | 4.4 | 3.8 | 0.00 | not significant |
